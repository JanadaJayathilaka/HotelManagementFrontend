    ...
    <div className="home">
      <section>
        <header className="header-banner">
          <img
            src="./src/assets/images/hotel.webp"
            alt="Jana Hotel"
          ...
          <div className="animated-texts overlay-content">
            <h1>
              Welcome to <span className="jana-color">Jana Hotel</span>
            </h1>
            <br />
      ...
      <h2 className="home-services">
        Services at <span className="jana-color">Jana Hotel</span>
      </h2>

      <section className="service-section">
        <div className="service-card">
          <img src="./src/assets/images/ac.png" alt="Air conditioning" />
